...
''');
      ...
      expect(chapters[1].HtmlContent, contains('This is the body of chapter one.'));
      ...
      expect(chapters[3].HtmlContent, contains('This is markdown chapter content.'));
    });

    test('parseChapters splits long files without markers into virtual 15,000 char blocks', () async {
